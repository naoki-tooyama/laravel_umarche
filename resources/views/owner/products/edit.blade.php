                ...
                <x-flash-message status="session('status')" />
                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          ...
                          <div class="w-full bg-gray-100 bg-opacity-50 border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            {{ $quantity }}
                          </div>
                        </div>
                      </div>
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative flex justify-around">
                          ...
                          <div><input type="radio" name="type" value="{{ Constant::PRODUCT_LIST['reduce'] }}" class="mr-2" >削除</div>
                       </div>
                      </div>
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                  ...
                  <form id="delete_{{$product->id}}" method="post" action="{{ route('owner.products.destroy', ['product' => $product->id])}}">
                    ...
                    <div class="p-2 w-full flex justify-around mt-32">
                      <a href="#" data-id="{{$product->id}}" onClick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded ">削除する</a>
                    </div>
                  </form>
              </div>
          </div>
